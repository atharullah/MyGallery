...
public class Activity_Pdf_Albums extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        try {
            ...
            setContentView(R.layout.activity__pdf__albums);
            MainLayout = findViewById(R.id.layoutPdfAlbums);
            recyclerView = findViewById(R.id.rcvPdfAlbums);
            CheckPerm();

            refreshLayout=findViewById(R.id.layoutPdfAlbumsRefresh);
    ...
    void GetPdfData() {
        ArrayList<EntityPdfAlbum> AllPdfAlbums = EntityPdfAlbum.getAllPdfAlbums(this);
        GridLayoutManager gridMgr = new GridLayoutManager(this, 2);
        recyclerView.setLayoutManager(gridMgr);
        recyclerView.setAdapter(new PdfAlbumAdapter(this, AllPdfAlbums));
    }
    ...
    void PermSnackBar(View layout) {
        ...
        bootomBar.setAction("Grant", new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ActivityCompat.requestPermissions(Activity_Pdf_Albums.this, Permissions, PermissionStatus);
            }
        });
        bootomBar.show();
    }
